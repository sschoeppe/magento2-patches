...
amzn/amazon-pay-and-login-with-amazon-core-module|Patch-amzn-amazon-pay-and-login-with-amazon-core-module.patch|fix missing street address for German addresses|Mage <2.3 Module <2.14
...
```
{
    "extra": {
        ...
        "patches": {
            ...
            "Fix missing street in german orders https://github.com/amzn/amazon-payments-magento-2-plugin/issues/442": "https://github.com/webvisum/magento2-patches/Patch-amzn-amazon-pay-and-login-with-amazon-core-module.patch"
            }
        }
    }
}
